...
namespace CustomerManagement.API.Migrations
{
    ...
    [Migration("20240717113648_RemovePaymentRecordTable")]
    partial class RemovePaymentRecordTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerManagement.Model.Payment", b =>
                {
                    b.HasOne("CustomerManagement.Model.Order", "OrderOfPayment")
                        .WithMany("PaymentsOfOrder")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
